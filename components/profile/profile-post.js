...
function ProfilePost() {
    return (
        <div className="col-span-2 h-auto relative hover:bg-gray-700 group cursor-pointer">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex space-x-2  text-white pointer-events-none invisible z-10 group-hover:visible">
